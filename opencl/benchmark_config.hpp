// =============================================================
// benchmark_config.hpp (Extra-light Linear Algebra test)
// - Further reduced for faster debugging on CPU / PoCL
// =============================================================
#pragma once
#include <vector>
#include <string>
...
static const std::vector<BenchConfig> BENCHMARKS = {
    ...
    {"gemv_shared",      {16, 32, 64, 128},          DTypeMode::FLOATING, false}, //core dumped
